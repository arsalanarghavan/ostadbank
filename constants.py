...
class States(Enum):
    ...
    GETTING_TEACHING_RATING = auto()
    GETTING_TEACHING_DETAILS = auto()
    GETTING_NOTES_CHOICE = auto()
    GETTING_NOTES_DETAILS = auto()
    GETTING_PROJECT_CHOICE = auto()
    GETTING_PROJECT_DETAILS = auto()
    GETTING_ATTENDANCE_CHOICE = auto()
    GETTING_ATTENDANCE_DETAILS = auto()
    GETTING_EXAM_CHOICE = auto()
    GETTING_EXAM_DIFFICULTY = auto()
    GETTING_EXAM_DETAILS = auto()
    GETTING_CONCLUSION = auto()
    GETTING_OVERALL_RATING = auto()
...
YES_NO_CHOICE = r"^(notes|project|exam|attendance)_(yes|no)$" # Generic Yes/No
